export const dataList = [
  {
    ...
    features: [
      ...
      "Find location based on user input of Location/Latitude, Longitude",
    ],
    languageUsed: [
      "Python",
    ],
    techUsed: [
      "PyQT5 GUI",
      "Folium (Map module used to show routes and markers)",
  ...
  },
  {
    ...
    features: [
      ...
      "Application of Java knowledge, IoT, file I/O, and potentially socket programming",
    ],    
    languageUsed: [
      "Java",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Inclusion of smart lighting to create a calming atmosphere",
      "Incorporation of smart lullaby feature for soothing the baby",
    ],
    languageUsed: [
      "Python",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "One-player mode, after the player picks his/her move, the minimax algorithm will be called and the computer will pick its best move against the player according to the level",
      "Introduced “easy”, “medium” and “hard” mode so that the kids will have a chance to beat the AI to promote cognitive learning",
    ],
    languageUsed: [
      "C",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Design and implementation of assembly language programming codes for tasks including writing data into and reading data out from RAM, and controlling LED lights through GPIO pins",
    ],
    languageUsed: [
      "C",
      "Assembly",
  ...
  },
  {
    ...
    features: [
      ...
      "Utilization of drag and drop functionality to streamline form creation, allowing users to easily build forms by dragging and dropping elements onto a droppable area",
      "Continued form editing functionality, enabling users to resume previous editing sessions and preserving their progress, enhancing user experience and productivity",
    ],
    languageUsed: [
      "PHP",
      "JavaScript",
  ...
  },
  {
    ...
    features: [
      ...
      "MongoDB for seamless booking process and prompt confirmations",
    ],
    languageUsed: [
      "JavaScript",
      "HTML",
